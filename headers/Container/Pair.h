...
AE2F struct ae2f_Pair* ae2f_Pair_set(struct ae2f_Pair* _this, struct ae2f_Dynamic val, char where);
AE2F struct ae2f_Dynamic ae2f_Pair_get(struct ae2f_Pair* _this, char where);
